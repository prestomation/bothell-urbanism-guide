# CLAUDE.md - AI Assistant Guide for Bothell Urbanism Guide

## Project Overview

This is a **Hugo static site** serving as a practical reference guide for Bothell urbanists and advocates. It helps people understand urban planning issues, learn terminology, and prepare for community participation.

- **Site URL**: https://bothell.urbanism-guide.com/
...
│   ├── _index.md        # Homepage
│   ├── quick-start/     # Bothell governance & context
...
│   └── check-external-links.py # Validates external URLs in content
...
- `housing-zoning.md` - ADU, DADU, FAR, HB 1110, middle housing, etc.
- `transportation.md` - BRT, Stride, Swift, mode share, complete streets, etc.
- `land-use.md` - SEPA, comprehensive plan, GMA, etc.
- `funding-policy.md` - TIF, MFTE, impact fees, CTR, etc.
...
**Why it matters:** Explain relevance to Bothell urbanists.
...
- **Primary source (required):** Must be a governmental or official institutional source (e.g., bothellwa.gov, soundtransit.org, wsdot.wa.gov, mrsc.org, commerce.wa.gov, communitytransit.org)
- **Secondary source (preferred):** The Urbanist (theurbanist.org) when relevant coverage exists, or other reputable local journalism/policy sources (Sightline, Publicola)
...
Guides are in-depth pages covering a specific urbanism topic in Bothell. Each guide lives as a single Markdown file in `content/guides/`.
...
## History
Chronological ### subheadings (e.g., "### 2019: Swift Green Line opens").
...
## Data sources
Where to find official data: city dashboards, open data portals, maps.
...
- Prefer bothellwa.gov, soundtransit.org, communitytransit.org, wsdot.wa.gov, mrsc.org as primary sources
...
- **Avoid subjective or editorial language** -- stick to verifiable facts and let readers draw their own conclusions

**Source requirements for guides:**
- **Primary sources (required):** Government or official institutional sources (bothellwa.gov, soundtransit.org, communitytransit.org, wsdot.wa.gov, mrsc.org, commerce.wa.gov, engagebothell.com)
- **Secondary sources (preferred):** The Urbanist, Sightline, Cascade PBS, local journalism
...
9. **Bothell straddles two counties**: Content should acknowledge that Bothell spans King County and Snohomish County when relevant. Different agencies serve different parts of the city.

## Bothell-Specific Context

### Key Agencies
- **City of Bothell**: [bothellwa.gov](https://www.bothellwa.gov/)
- **Community Development**: [bothellwa.gov/300/Community-Development](https://www.bothellwa.gov/300/Community-Development)
- **Planning Commission**: [bothellwa.gov/274/Planning-Commission](https://www.bothellwa.gov/274/Planning-Commission)
- **Engage Bothell**: [engagebothell.com](https://engagebothell.com/)
- **Sound Transit**: [soundtransit.org](https://www.soundtransit.org/)
- **Community Transit**: [communitytransit.org](https://www.communitytransit.org/)
- **King County Metro**: [kingcounty.gov/metro](https://kingcounty.gov/en/dept/metro)

### Key Current Projects
- **Stride S3 BRT** (SR 522, opening ~2028)
- **Stride S2 BRT** (I-405)
- **Swift Green Line Extension** (into Downtown Bothell, ~2031)
- **I-405/Brickyard to SR 527** ($834M WSDOT project, completion ~2028)
- **Bothell Way NE Multimodal Improvements** ($63M)
- **Imagine Bothell Comprehensive Plan** (adopted Dec 2024)
- **Downtown Subarea Plan** (in progress)
...
**Color palette:** The site uses a Pacific Northwest nature-inspired palette defined as CSS variables in `:root`. Always use these variables — never hardcode colors.

| Variable | Light | Dark | Inspiration |
|---|---|---|---|
| `--color-link` | `#2D6A4F` Forest Green | `#76C893` Spring Green | PNW forests |
| `--accent-teal` | `#168AAD` River Blue | `#56CFE1` Light Teal | Sammamish River |
| `--accent-emerald` | `#52B788` Green | `#95D5B2` | Forest canopy |
| `--accent-gold` | `#E9B44C` Amber Gold | `#FFD166` | Warm accent |
| `--accent-gradient` | Green → Blue | Lightened | Both |
